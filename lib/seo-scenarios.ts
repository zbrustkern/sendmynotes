...
export const SEO_SCENARIOS: ScenarioConfig[] = [
  // 1. CAREER: Post Job Interview Thank You
  {
    ...
    coverPrompt: "Minimalist executive desk with a vintage brass fountain pen resting on cream deckled-edge paper, warm natural light, quiet luxury stationery aesthetic",
  ...
  // 2. CAREER: Thank You to Mentor or Advisor
  {
    ...
    metaDescription: "Express deep gratitude to a mentor, professor, or advisor with a physical card inked by robotic pen and mailed directly to their door.",
    keywords: [
  ...
  // 3. CAREER / BUSINESS: Client Closing Appreciation
  {
    ...
    coverPrompt: "Modern architectural sanctuary with sunlit limestone, lush green olive branches, quiet luxury, greeting card cover",
  ...
  // 5. SYMPATHY: Loss of a Parent
  {
    ...
    coverPrompt: "Misty evergreen forest at dawn, quiet mountain mist, peaceful serene watercolor nature, contemplative greeting card",
  ...
  // 6. MILESTONES: Housewarming / New Home
  {
    ...
    coverPrompt: "Charming sunlit doorway surrounded by flowering jasmine and terracotta pots, welcoming warm aesthetic watercolor 5:7",
  ...
  // 7. MILESTONES: Promotion or New Job
  {
    ...
    metaDescription: "Celebrate a promotion, new role, or company launch with a personalized handwritten card penned by robots and mailed via USPS.",
    keywords: [
    ...
    coverUrl: "https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?auto=format&fit=crop&w=1250&h=1750&q=80",
    coverPrompt: "Golden effervescent champagne bubbles rising in vintage crystal coupe, celebratory starbursts, festive modern card art",
  ...
  // 8. BIRTHDAY: Milestone 50th, 60th, or 70th Birthday
  {
    ...
    metaDescription: "Honor milestone birthdays with a luxurious real pen-on-paper card. Pre-filled with celebratory words, written by robotic pen and mailed for $9.",
    keywords: [
    ...
    coverUrl: "https://images.unsplash.com/photo-1530103862676-de8c9debad1d?auto=format&fit=crop&w=1250&h=1750&q=80",
    coverPrompt: "Golden balloons floating into pastel sunset sky, gold foil flecks, elegant celebratory greeting card cover art",
  ...
  // 9. BIRTHDAY: Long Distance Best Friend
  {
    ...
    coverUrl: "https://images.unsplash.com/photo-1518895949257-7621c3c786d7?auto=format&fit=crop&w=1250&h=1750&q=80",
  ...
  // 10. ANNIVERSARY: Heartfelt Love Note to Spouse
  {
    ...
    coverUrl: "https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?auto=format&fit=crop&w=1250&h=1750&q=80",
    coverPrompt: "Lush deep emerald monstera and eucalyptus leaves with delicate golden geometry, intimate card design 5:7",
  ...
  // 11. HEALTH & SUPPORT: Surgery & Hospital Recovery
  {
    ...
    coverUrl: "https://images.unsplash.com/photo-1509042239860-f550ce710b93?auto=format&fit=crop&w=1250&h=1750&q=80",
    coverPrompt: "Warm ceramic tea cup with steam curling into soft clouds, morning sunlight, cozy healing card illustration",
  ...
  // 12. EMPATHY: Thinking of You During Hard Times
  {
    ...
    coverUrl: "https://images.unsplash.com/photo-1490750967868-88aa4486c946?auto=format&fit=crop&w=1250&h=1750&q=80",
    coverPrompt: "Quiet wildflower meadow at twilight, soft lavender and sage tones, gentle minimalist landscape painting, peaceful card",
