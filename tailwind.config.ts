  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        hwKate: ["var(--font-hw-kate)", "'HandwryttenKate'", "Caveat", "cursive"],
        hwWill: ["var(--font-hw-will)", "'HandwryttenWill'", "'Courier New'", "monospace"],
        handwriting: ["var(--font-hw-david)", "Caveat", "'Bradley Hand'", "cursive"],
